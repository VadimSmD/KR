...
//
// POST /user
func (UnimplementedHandler) CreateUser(ctx context.Context, req CreateUserReq) (r *UserStatusCode, _ error) {
...
//
// PUT /user/{username}
func (UnimplementedHandler) UpdateUser(ctx context.Context, req UpdateUserReq, params UpdateUserParams) (r *UpdateUserDef, _ error) {
	return r, ht.ErrNotImplemented
}
