...
func encodeCreateUserResponse(response *UserStatusCode, w http.ResponseWriter, span trace.Span) error {
...
func encodeUpdateUserResponse(response *UpdateUserDef, w http.ResponseWriter, span trace.Span) error {
	code := response.StatusCode
	if code == 0 {
		// Set default status code.
		code = http.StatusOK
